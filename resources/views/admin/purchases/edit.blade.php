                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('purchases.update', $purchase->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-10">
                                    <select name="invoice_id" id="invoice_id" class="form-control" required>
                                        ...
                                        @foreach ($invoices as $invoice)
                                            <option {{ ($invoice->id == $purchase->invoice->id) ? 'selected': '' }} value="{{$invoice->id}}">{{$invoice->id}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="voucher_number" id="voucher_number" class="form-control" required value="{{ $purchase->voucher_number }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" name="purchase_date" id="purchase_date" class="form-control" required value="{{ $purchase->purchase_date }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" name="total_amount" id="total_amount" class="form-control" required value="{{ $purchase->total_amount }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select name="payment_status" id="payment_status" class="form-control" required>
                                        ...
                                        <option {{ ($purchase->payment_status == 3) ? 'selected' : '' }} value="3">Cancelled</option>
                                    </select>
                                </div>
                            </div>
